			    		...
			    		<div class="content_sec">
			    			<section id="form_">
								<s:actionerror cssClass="formError"/>
								   <s:form action="fileUpload"  method="post" validate="true" cssClass="formAddMod" theme="simple">
									<table>
										<tr>
											<td>
												<s:label value="Nom du projet " theme="simple"></s:label>
												<s:textfield name="myFile.name" cssClass="formInput" label="Nom du projet" theme="simple"/>
											</td>
										</tr>
										<tr>
											<td>
												<s:label value="Chemin" theme="simple"></s:label>
												<s:textfield name="myFile.folder" cssClass="formInput" label="dossier" theme="simple"/>
											</td>
										</tr>
										<tr>
											<td>
												...
												<s:select label="Utilisateurs"
											     ...
											     />
											     <s:a href="#" onclick="listbox_moveacross('fileUpload_users', 'fileUpload_users_chosen_ID')"> <img  src="./Images/right_fleche.png"/></s:a>
												 <s:a href="#" onclick="listbox_moveacross('fileUpload_users_chosen_ID', 'fileUpload_users')"><img  src="./Images/left_fleche.png"/></s:a>
											     <s:select label="Utilisateurs"
										...
										<tr>
											<td>
										     	<s:submit type="submit" value="Importer" align="center" cssClass="submit" labelposition="right" theme="simple" onclick="return selectAll();"/>
											</td>
										</tr>
									</table>
								</s:form>
